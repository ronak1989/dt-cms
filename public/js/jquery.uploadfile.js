...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        function serializeAndUploadFiles(s, obj, files) {
            for (var i = 0; i < files.length; i++) {
            	...
            	if(s.showFileCounter)
            		fileNameStr = '<span class="file-'+s.customclass+'" filename="'+files[i].name+'">'+obj.fileCounter + s.fileCounterStyle + files[i].name+'</span>';
            	else
            		fileNameStr = '<span class="file-'+s.customclass+'" filename="'+files[i].name+'">'+files[i].name+'</span>';
            ...
            fileInput.change(function () {
                ...
                if (feature.fileapi && feature.formdata) //use HTML5 support and split file submission
                {
                    ...
                    for (var i = 0; i < fileArray.length; i++) {
		            	if(s.showFileCounter)
        		    		fileList += '<span class="file-'+s.customclass+'" filename="'+fileArray[i]+'">'+obj.fileCounter + s.fileCounterStyle + fileArray[i]+"</span><br>";
            			else
		            		fileList += '<span class="file-'+s.customclass+'" filename="'+fileArray[i]+'">'+fileArray[i]+"</span><br>";
                        obj.fileCounter++;
                    }
                    var pd = new createProgressDiv(obj, s);
        ...
        function createProgressDiv(obj, s) {
            customFileProgressDivId++;
            this.statusbar = $("<div id='FileBox"+customFileProgressDivId+"'' class='ajax-file-upload-statusbar'></div>");
            this.filename = $("<div class='ajax-file-upload-filename "+s.customclass+"'></div>").appendTo(this.statusbar);
